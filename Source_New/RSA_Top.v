...
module RSA_top (
    ...
    localparam STATE_IDLE        = 4'd0,
               ...
               STATE_START_PAD   = 4'd8,  // Trang thai kich hoat chen dem padding
               STATE_WAIT_PAD    = 4'd9,  // Trang thai doi chen dem padding xong
               STATE_START_EXP   = 4'd11,
               STATE_WAIT_EXP    = 4'd12,
               STATE_START_UNPAD = 4'd14, // Trang thai kich hoat boc go padding
               STATE_WAIT_UNPAD  = 4'd15, // Trang thai doi boc go padding xong
               STATE_DONE        = 4'd13;
